...
.method public run()V
    ...
    .line 679
    .local v2, "$r2":Ljava/io/FilenameFilter;, ""
    ...
    invoke-virtual {v0, v3}, Lcom/crashlytics/android/core/CrashlyticsUncaughtExceptionHandler;->doCleanInvalidTempFiles([Ljava/io/File;)V

    .line 681
    return-void
    .end local v0    # "$r1":Lcom/crashlytics/android/core/CrashlyticsUncaughtExceptionHandler;, ""
    .end local v2    # "$r2":Ljava/io/FilenameFilter;, ""
