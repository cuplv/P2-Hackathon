...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->mMaxIconSize:I
    ...
    iput v5, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->mSavedPaddingLeft:I
...
.method static synthetic access$000(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/ActionMenuItemView$PopupCallback;
    ...
    .local v0, "r1":Landroid/support/v7/view/menu/ActionMenuItemView$PopupCallback;, ""
    return-object v0
    .end local v0    # "r1":Landroid/support/v7/view/menu/ActionMenuItemView$PopupCallback;, ""
.end method
...
.method static synthetic access$100(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/MenuBuilder$ItemInvoker;
    ...
    .local v0, "r1":Landroid/support/v7/view/menu/MenuBuilder$ItemInvoker;, ""
    return-object v0
    .end local v0    # "r1":Landroid/support/v7/view/menu/MenuBuilder$ItemInvoker;, ""
.end method
...
.method public initialize(Landroid/support/v7/view/menu/MenuItemImpl;I)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/view/menu/ActionMenuItemView;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .local v3, "$b1":B, ""
    :goto_1e
    invoke-virtual {p0, v3}, Landroid/support/v7/view/menu/ActionMenuItemView;->setVisibility(I)V
    ...
    .line 119
    invoke-virtual {p0, v2}, Landroid/support/v7/view/menu/ActionMenuItemView;->setEnabled(Z)V
    ...
    .line 121
    iget-object v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->mForwardingListener:Landroid/support/v7/widget/ListPopupWindow$ForwardingListener;

    .local v4, "$r4":Landroid/support/v7/widget/ListPopupWindow$ForwardingListener;, ""
    if-nez v4, :cond_3d

    .line 122
    new-instance v5, Landroid/support/v7/view/menu/ActionMenuItemView$ActionMenuItemForwardingListener;

    .line 122
    .local v5, "$r5":Landroid/support/v7/view/menu/ActionMenuItemView$ActionMenuItemForwardingListener;, ""
    invoke-direct {v5, p0}, Landroid/support/v7/view/menu/ActionMenuItemView$ActionMenuItemForwardingListener;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object v5, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->mForwardingListener:Landroid/support/v7/widget/ListPopupWindow$ForwardingListener;
    ...
    .end local p2    # "$i0":I, ""
    .end local v5    # "$r5":Landroid/support/v7/view/menu/ActionMenuItemView$ActionMenuItemForwardingListener;, ""
    .end local v2    # "$z0":Z, ""
...
.method public needsDividerBefore()Z
    ...
    .line 222
    .local v1, "$r1":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    ...
    .end local v0    # "$z0":Z, ""
    .end local v1    # "$r1":Landroid/support/v7/view/menu/MenuItemImpl;, ""
.end method
...
.method public onClick(Landroid/view/View;)V
    ...
    .local v0, "$r3":Landroid/support/v7/view/menu/MenuBuilder$ItemInvoker;, ""
    if-eqz v0, :cond_b
    ...
    .end local v0    # "$r3":Landroid/support/v7/view/menu/MenuBuilder$ItemInvoker;, ""
.end method
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .local v4, "$z0":Z, ""
    iput-boolean v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->mAllowTextWithIcon:Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 238
    invoke-virtual {v0, v3}, Landroid/support/v7/view/menu/ActionMenuItemView;->getLocationOnScreen([I)V

    .line 239
    move-object/from16 v0, p0

    .line 239
    invoke-virtual {v0, v4}, Landroid/support/v7/view/menu/ActionMenuItemView;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    .line 241
    move-object/from16 v0, p0

    .line 241
    invoke-virtual {v0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getContext()Landroid/content/Context;
    ...
    .line 242
    invoke-virtual {v0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getWidth()I
    ...
    .line 243
    invoke-virtual {v0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getHeight()I
    ...
    .line 250
    .local v12, "$r7":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    iget-object v12, v0, Landroid/support/v7/view/menu/ActionMenuItemView;->mItemData:Landroid/support/v7/view/menu/MenuItemImpl;

    .line 250
    invoke-virtual {v12}, Landroid/support/v7/view/menu/MenuItemImpl;->getTitle()Ljava/lang/CharSequence;
    ...
    goto :goto_70
    .end local v8    # "$i0":I, ""
    .end local v12    # "$r7":Landroid/support/v7/view/menu/MenuItemImpl;, ""
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->mForwardingListener:Landroid/support/v7/widget/ListPopupWindow$ForwardingListener;
...
.method public setExpandedFormat(Z)V
    ...
    .line 167
    invoke-virtual {v1}, Landroid/support/v7/view/menu/MenuItemImpl;->actionFormatChanged()V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 197
    invoke-virtual {p0, p1, v9, v10, v11}, Landroid/support/v7/view/menu/ActionMenuItemView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
