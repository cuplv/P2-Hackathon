...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Landroid/support/v7/view/menu/MenuBuilder;->mResources:Landroid/content/res/Resources;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/MenuBuilder;->mVisibleItems:Ljava/util/ArrayList;
...
.method private dispatchPresenterUpdate(Z)V
    ...
    .local v6, "$r5":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez v6, :cond_30
    ...
    .line 284
    :cond_30
    invoke-interface {v6, p1}, Landroid/support/v7/view/menu/MenuPresenter;->updateMenuView(Z)V
    ...
    .end local v6    # "$r5":Landroid/support/v7/view/menu/MenuPresenter;, ""
.end method
...
.method private dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    check-cast v9, Landroid/support/v7/view/menu/MenuPresenter;

    move-object v8, v9

    .local v8, "$r7":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez v8, :cond_35
    ...
    .line 349
    invoke-interface {v8, v11}, Landroid/support/v7/view/menu/MenuPresenter;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .end local v8    # "$r7":Landroid/support/v7/view/menu/MenuPresenter;, ""
.end method
...
.method private dispatchSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .local v7, "$r7":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez v7, :cond_32
    ...
    .line 322
    :cond_32
    invoke-interface {v7}, Landroid/support/v7/view/menu/MenuPresenter;->getId()I
    ...
    .line 324
    invoke-interface {v7}, Landroid/support/v7/view/menu/MenuPresenter;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .end local v7    # "$r7":Landroid/support/v7/view/menu/MenuPresenter;, ""
    .end local v9    # "$i0":I, ""
...
.method private dispatchSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;Landroid/support/v7/view/menu/MenuPresenter;)Z
    ...
    .local p2, "$r2":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez p2, :cond_35
    ...
    .end local v3    # "$r4":Ljava/util/Iterator;, ""
    .end local v6    # "$r6":Ljava/lang/ref/WeakReference;, ""
    .end local p2    # "$r2":Landroid/support/v7/view/menu/MenuPresenter;, ""
.end method
...
.method private static findInsertIndex(Ljava/util/ArrayList;I)I
    ...
    .line 826
    .local v2, "$r2":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    invoke-virtual {v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getOrdering()I
    ...
    return v5
    .end local v2    # "$r2":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v0    # "$i1":I, ""
    .end local v4    # "$i2":I, ""
...
.method public add(I)Landroid/view/MenuItem;
    ...
    .line 462
    invoke-virtual {p0, v3, v4, v5, v1}, Landroid/support/v7/view/menu/MenuBuilder;->addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method public add(IIII)Landroid/view/MenuItem;
    ...
    .line 472
    .local v1, "$r2":Ljava/lang/String;, ""
    invoke-virtual {p0, p1, p2, p3, v1}, Landroid/support/v7/view/menu/MenuBuilder;->addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method public add(Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    .line 457
    invoke-virtual {p0, v1, v2, v3, p1}, Landroid/support/v7/view/menu/MenuBuilder;->addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method public addIntentOptions(IIILandroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I[Landroid/view/MenuItem;)I
    ...
    iget-object v5, v0, Landroid/support/v7/view/menu/MenuBuilder;->mContext:Landroid/content/Context;
    ...
    .line 508
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/MenuBuilder;->removeGroup(I)V
    ...
    .line 518
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/support/v7/view/menu/MenuBuilder;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method protected addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    .line 433
    invoke-static {v0}, Landroid/support/v7/view/menu/MenuBuilder;->getOrdering(I)I

    move-result v7

    .line 435
    .local v7, "$i4":I, ""
    iget v8, p0, Landroid/support/v7/view/menu/MenuBuilder;->mDefaultShowAsAction:I
    ...
    .line 438
    .local v9, "$r2":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    iget-object v10, p0, Landroid/support/v7/view/menu/MenuBuilder;->mCurrentMenuInfo:Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    .line 440
    invoke-virtual {v9, v10}, Landroid/support/v7/view/menu/MenuItemImpl;->setMenuInfo(Landroid/view/ContextMenu$ContextMenuInfo;)V

    .line 443
    :cond_1f
    iget-object v11, p0, Landroid/support/v7/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;

    .local v11, "$r4":Ljava/util/ArrayList;, ""
    iget-object v12, p0, Landroid/support/v7/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;

    .line 443
    .local v12, "$r5":Ljava/util/ArrayList;, ""
    invoke-static {v12, v7}, Landroid/support/v7/view/menu/MenuBuilder;->findInsertIndex(Ljava/util/ArrayList;I)I
    ...
    .line 444
    invoke-virtual {p0, v13}, Landroid/support/v7/view/menu/MenuBuilder;->onItemsChanged(Z)V

    .line 446
    return-object v9
    .end local v7    # "$i4":I, ""
    .end local v11    # "$r4":Ljava/util/ArrayList;, ""
    .end local v9    # "$r2":Landroid/support/v7/view/menu/MenuItemImpl;, ""
...
.method public addSubMenu(I)Landroid/view/SubMenu;
    ...
    .line 482
    invoke-virtual {p0, v3, v4, v5, v1}, Landroid/support/v7/view/menu/MenuBuilder;->addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
...
.method public addSubMenu(IIII)Landroid/view/SubMenu;
    ...
    .line 496
    .local v1, "$r2":Ljava/lang/String;, ""
    invoke-virtual {p0, p1, p2, p3, v1}, Landroid/support/v7/view/menu/MenuBuilder;->addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
...
.method public addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    .line 488
    .local v1, "$r5":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    new-instance v3, Landroid/support/v7/view/menu/SubMenuBuilder;

    .local v3, "$r2":Landroid/support/v7/view/menu/SubMenuBuilder;, ""
    iget-object v4, p0, Landroid/support/v7/view/menu/MenuBuilder;->mContext:Landroid/content/Context;

    .line 488
    .local v4, "$r3":Landroid/content/Context;, ""
    invoke-direct {v3, v4, p0, v1}, Landroid/support/v7/view/menu/SubMenuBuilder;-><init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    .line 491
    return-object v3
    .end local v3    # "$r2":Landroid/support/v7/view/menu/SubMenuBuilder;, ""
    .end local v0    # "$r4":Landroid/view/MenuItem;, ""
    .end local v1    # "$r5":Landroid/support/v7/view/menu/MenuItemImpl;, ""
...
.method public addSubMenu(Ljava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    .line 477
    invoke-virtual {p0, v1, v2, v3, p1}, Landroid/support/v7/view/menu/MenuBuilder;->addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
...
.method public final close(Z)V
    ...
    .local v7, "$r5":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez v7, :cond_2c
    ...
    .line 1005
    :cond_2c
    invoke-interface {v7, p0, p1}, Landroid/support/v7/view/menu/MenuPresenter;->onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .end local v7    # "$r5":Landroid/support/v7/view/menu/MenuPresenter;, ""
    .end local v0    # "$z1":Z, ""
.end method
...
.method public collapseItemActionView(Landroid/support/v7/view/menu/MenuItemImpl;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/MenuBuilder;->mExpandedItem:Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    check-cast v10, Landroid/support/v7/view/menu/MenuPresenter;

    move-object v9, v10

    .local v9, "$r7":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez v9, :cond_36
    ...
    .line 1345
    :cond_36
    invoke-interface {v9, p0, p1}, Landroid/support/v7/view/menu/MenuPresenter;->collapseItemActionView(Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuItemImpl;)Z
    ...
    iput-object v11, p0, Landroid/support/v7/view/menu/MenuBuilder;->mExpandedItem:Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .end local v9    # "$r7":Landroid/support/v7/view/menu/MenuPresenter;, ""
...
.method dispatchMenuItemSelected(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    .local v0, "$r3":Landroid/support/v7/view/menu/MenuBuilder$Callback;, ""
    if-eqz v0, :cond_e
    ...
    return v2
    .end local v1    # "$z0":Z, ""
    .end local v0    # "$r3":Landroid/support/v7/view/menu/MenuBuilder$Callback;, ""
.end method
...
.method public expandItemActionView(Landroid/support/v7/view/menu/MenuItemImpl;)Z
    ...
    .local v8, "$r6":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez v8, :cond_32
    ...
    .line 1323
    :cond_32
    invoke-interface {v8, p0, p1}, Landroid/support/v7/view/menu/MenuPresenter;->expandItemActionView(Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuItemImpl;)Z
    ...
    :cond_40
    return v1
    .end local v8    # "$r6":Landroid/support/v7/view/menu/MenuPresenter;, ""
    .end local v4    # "$z1":Z, ""
...
.method public findGroupIndex(II)I
    ...
    .line 715
    .local v3, "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    ...
    .end local v3    # "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
...
.method public findItem(I)Landroid/view/MenuItem;
    ...
    .line 674
    .local v4, "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    ...
    .end local v6    # "$i3":I, ""
    .end local v7    # "$z0":Z, ""
    .end local v4    # "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v1    # "$i2":I, ""
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    iget-object v3, v0, Landroid/support/v7/view/menu/MenuBuilder;->mTempShortcutItemList:Ljava/util/ArrayList;
    ...
    .line 905
    invoke-virtual {v0, v3, v1, v2}, Landroid/support/v7/view/menu/MenuBuilder;->findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    .local v11, "$r5":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    return-object v11
    ...
    return-object v5
    .end local v11    # "$r5":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v18    # "$i6":I, ""
    .end local v8    # "$i2":I, ""
    .end local v17    # "$c5":C, ""
    .end local v4    # "$z0":Z, ""
...
.method findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    iget-object v8, v0, Landroid/support/v7/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;
    ...
    .line 873
    .local v12, "$r6":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    ...
    check-cast v16, Landroid/support/v7/view/menu/MenuBuilder;

    move-object/from16 v15, v16

    .line 874
    .local v15, "$r8":Landroid/support/v7/view/menu/MenuBuilder;, ""
    ...
    .line 874
    invoke-virtual {v15, v0, v1, v2}, Landroid/support/v7/view/menu/MenuBuilder;->findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    .end local v18    # "$i5":I, ""
    .end local v4    # "$i1":I, ""
    .end local v15    # "$r8":Landroid/support/v7/view/menu/MenuBuilder;, ""
    .end local v20    # "$c6":C, ""
    .end local v5    # "$r3":Landroid/view/KeyCharacterMap$KeyData;, ""
    .end local v8    # "$r4":Ljava/util/ArrayList;, ""
    .end local v12    # "$r6":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v9    # "$i2":I, ""
    .end local v3    # "$z0":Z, ""
    .end local v10    # "$i3":I, ""
...
.method public flagActionItems()V
    ...
    .line 1127
    .local v3, "$z0":Z, ""
    iget-boolean v3, v0, Landroid/support/v7/view/menu/MenuBuilder;->mIsActionItemsStale:Z
    ...
    iget-object v4, v0, Landroid/support/v7/view/menu/MenuBuilder;->mPresenters:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    check-cast v11, Landroid/support/v7/view/menu/MenuPresenter;

    move-object v10, v11

    .local v10, "$r6":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-nez v10, :cond_36
    ...
    .line 1138
    :cond_36
    invoke-interface {v10}, Landroid/support/v7/view/menu/MenuPresenter;->flagActionItems()Z
    ...
    iget-object v13, v0, Landroid/support/v7/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
    ...
    .line 1144
    iget-object v13, v0, Landroid/support/v7/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
    ...
    .line 1148
    .local v16, "$r8":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    ...
    .line 1157
    iget-object v2, v0, Landroid/support/v7/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
    ...
    .line 1158
    iget-object v2, v0, Landroid/support/v7/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
    ...
    .end local v10    # "$r6":Landroid/support/v7/view/menu/MenuPresenter;, ""
    .end local v6    # "$z1":Z, ""
    .end local v16    # "$r8":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v15    # "$i1":I, ""
...
.method public getVisibleItems()Ljava/util/ArrayList;
    ...
    .line 1089
    .local v5, "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    invoke-virtual {v5}, Landroid/support/v7/view/menu/MenuItemImpl;->isVisible()Z
    ...
    iput-boolean v7, p0, Landroid/support/v7/view/menu/MenuBuilder;->mIsVisibleItemsStale:Z
    ...
    .end local v3    # "$i1":I, ""
    .end local v0    # "$z0":Z, ""
    .end local v5    # "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
...
.method public hasVisibleItems()Z
    ...
    .line 661
    .local v6, "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    invoke-virtual {v6}, Landroid/support/v7/view/menu/MenuItemImpl;->isVisible()Z
    ...
    .end local v2    # "$i0":I, ""
    .end local v6    # "$r3":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v0    # "$z0":Z, ""
...
.method public performItemAction(Landroid/view/MenuItem;I)Z
    ...
    .line 948
    invoke-virtual {p0, p1, v1, p2}, Landroid/support/v7/view/menu/MenuBuilder;->performItemAction(Landroid/view/MenuItem;Landroid/support/v7/view/menu/MenuPresenter;I)Z
...
.method public performItemAction(Landroid/view/MenuItem;Landroid/support/v7/view/menu/MenuPresenter;I)Z
    ...
    .line 969
    new-instance v8, Landroid/support/v7/view/menu/SubMenuBuilder;

    .line 969
    .local v8, "$r5":Landroid/support/v7/view/menu/SubMenuBuilder;, ""
    invoke-virtual {p0}, Landroid/support/v7/view/menu/MenuBuilder;->getContext()Landroid/content/Context;
    ...
    invoke-direct {v8, v9, p0, v0}, Landroid/support/v7/view/menu/SubMenuBuilder;-><init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuItemImpl;)V

    .line 969
    invoke-virtual {v0, v8}, Landroid/support/v7/view/menu/MenuItemImpl;->setSubMenu(Landroid/support/v7/view/menu/SubMenuBuilder;)V
    ...
    .local v10, "$r7":Landroid/view/SubMenu;, ""
    move-object v11, v10

    check-cast v11, Landroid/support/v7/view/menu/SubMenuBuilder;
    ...
    .line 974
    invoke-virtual {v4, v8}, Landroid/support/v4/view/ActionProvider;->onPrepareSubMenu(Landroid/view/SubMenu;)V

    .line 976
    :cond_60
    invoke-direct {p0, v8, p2}, Landroid/support/v7/view/menu/MenuBuilder;->dispatchSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;Landroid/support/v7/view/menu/MenuPresenter;)Z
...
.method public removeGroup(I)V
    ...
    .line 543
    invoke-direct {p0, v0, v8}, Landroid/support/v7/view/menu/MenuBuilder;->removeItemAtInt(IZ)V
    ...
    .line 547
    invoke-virtual {p0, v8}, Landroid/support/v7/view/menu/MenuBuilder;->onItemsChanged(Z)V
...
.method public removeMenuPresenter(Landroid/support/v7/view/menu/MenuPresenter;)V
    ...
    .local v6, "$r6":Landroid/support/v7/view/menu/MenuPresenter;, ""
    if-eqz v6, :cond_20
    ...
    .end local v6    # "$r6":Landroid/support/v7/view/menu/MenuPresenter;, ""
.end method
...
.method public restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    .line 408
    .local v10, "$r7":Landroid/support/v7/view/menu/SubMenuBuilder;, ""
    invoke-virtual {v10, p1}, Landroid/support/v7/view/menu/SubMenuBuilder;->restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    .end local v6    # "$i2":I, ""
    .end local v10    # "$r7":Landroid/support/v7/view/menu/SubMenuBuilder;, ""
...
.method public saveActionViewStates(Landroid/os/Bundle;)V
    ...
    .line 382
    .local v10, "$r6":Landroid/support/v7/view/menu/SubMenuBuilder;, ""
    invoke-virtual {v10, p1}, Landroid/support/v7/view/menu/SubMenuBuilder;->saveActionViewStates(Landroid/os/Bundle;)V
    ...
    .end local v2    # "$i1":I, ""
    .end local v7    # "$z0":Z, ""
    .end local v10    # "$r6":Landroid/support/v7/view/menu/SubMenuBuilder;, ""
    .end local v1    # "$i0":I, ""
    .end local v5    # "$i2":I, ""
    .end local v0    # "$r2":Landroid/util/SparseArray;, ""
...
.method setExclusiveItemChecked(Landroid/view/MenuItem;)V
    ...
    .line 598
    .local v5, "$r4":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    ...
    .line 603
    :goto_2f
    invoke-virtual {v5, v8}, Landroid/support/v7/view/menu/MenuItemImpl;->setCheckedInt(Z)V
    ...
    :cond_35
    return-void
    .end local v5    # "$r4":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v1    # "$r2":Ljava/util/ArrayList;, ""
    .end local v3    # "$i2":I, ""
    .end local v8    # "$z0":Z, ""
    .end local v0    # "$i0":I, ""
...
.method public setGroupCheckable(IZZ)V
    ...
    .line 615
    invoke-virtual {v4, p3}, Landroid/support/v7/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V

    .line 616
    invoke-virtual {v4, p2}, Landroid/support/v7/view/menu/MenuItemImpl;->setCheckable(Z)Landroid/view/MenuItem;
...
.method public setGroupEnabled(IZ)V
    ...
    .line 646
    invoke-virtual {v4, p2}, Landroid/support/v7/view/menu/MenuItemImpl;->setEnabled(Z)Landroid/view/MenuItem;
...
.method public setGroupVisible(IZ)V
    ...
    .line 632
    invoke-virtual {v5, p2}, Landroid/support/v7/view/menu/MenuItemImpl;->setVisibleInt(Z)Z
    ...
    .line 636
    invoke-virtual {p0, v9}, Landroid/support/v7/view/menu/MenuBuilder;->onItemsChanged(Z)V
