...
.method private newInstance(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 497
    .local v0, "$r5":Landroid/support/v7/view/SupportMenuInflater;, ""
    ...
    .line 502
    .local v8, "$r11":Ljava/lang/StringBuilder;, ""
    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    .line 502
    const-string v9, "Cannot instantiate class: "
    ...
    const-string v9, "SupportMenuInflater"

    .line 502
    invoke-static {v9, p1, v7}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .end local v0    # "$r5":Landroid/support/v7/view/SupportMenuInflater;, ""
    .end local v3    # "$r8":Ljava/lang/Class;, ""
    .end local v8    # "$r11":Ljava/lang/StringBuilder;, ""
...
.method private setItem(Landroid/view/MenuItem;)V
    ...
    .line 425
    .local v3, "$z0":Z, ""
    iget-boolean v3, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemChecked:Z
    ...
    iget-boolean v3, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemVisible:Z
    ...
    iget-boolean v3, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemEnabled:Z
    ...
    .local v5, "$i0":I, ""
    iget v5, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemCheckable:I
    ...
    iget-object v7, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemTitleCondensed:Ljava/lang/CharSequence;
    ...
    iget v5, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemIconResId:I
    ...
    .local v8, "$c1":C, ""
    iget-char v8, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemAlphabeticShortcut:C
    ...
    iget-char v8, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemNumericShortcut:C
    ...
    .line 434
    iget v5, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemShowAsAction:I
    ...
    iget-object v9, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemListenerMethodName:Ljava/lang/String;
    ...
    .line 439
    .local v10, "$r5":Landroid/support/v7/view/SupportMenuInflater;, ""
    iget-object v10, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->this$0:Landroid/support/v7/view/SupportMenuInflater;

    .line 439
    # getter for: Landroid/support/v7/view/SupportMenuInflater;->mContext:Landroid/content/Context;
    invoke-static {v10}, Landroid/support/v7/view/SupportMenuInflater;->access$100(Landroid/support/v7/view/SupportMenuInflater;)Landroid/content/Context;
    ...
    .line 443
    :cond_72
    new-instance v14, Landroid/support/v7/view/SupportMenuInflater$InflatedOnMenuItemClickListener;

    .local v14, "$r8":Landroid/support/v7/view/SupportMenuInflater$InflatedOnMenuItemClickListener;, ""
    move-object/from16 v0, p0
    ...
    invoke-static {v10}, Landroid/support/v7/view/SupportMenuInflater;->access$400(Landroid/support/v7/view/SupportMenuInflater;)Ljava/lang/Object;
    ...
    .line 443
    invoke-direct {v14, v15, v9}, Landroid/support/v7/view/SupportMenuInflater$InflatedOnMenuItemClickListener;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 447
    instance-of v3, v0, Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 448
    .local v16, "$r10":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    :goto_94
    move-object/from16 v0, p0
    ...
    .line 450
    check-cast v18, Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 450
    invoke-virtual {v0, v6}, Landroid/support/v7/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V
    ...
    .line 457
    iget-object v9, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionViewClassName:Ljava/lang/String;
    ...
    invoke-static {v10}, Landroid/support/v7/view/SupportMenuInflater;->access$600(Landroid/support/v7/view/SupportMenuInflater;)[Ljava/lang/Object;
    ...
    .line 458
    invoke-direct {v0, v9, v1, v2}, Landroid/support/v7/view/SupportMenuInflater$MenuState;->newInstance(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 463
    iget v5, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionViewLayout:I
    ...
    iget-object v0, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionProvider:Landroid/support/v4/view/ActionProvider;
    ...
    .line 451
    instance-of v3, v0, Landroid/support/v7/view/menu/MenuItemWrapperICS;
    ...
    .line 452
    check-cast v25, Landroid/support/v7/view/menu/MenuItemWrapperICS;

    .line 452
    move-object/from16 v24, v25

    .line 452
    .local v24, "$r15":Landroid/support/v7/view/menu/MenuItemWrapperICS;, ""
    const/4 v6, 0x1
    ...
    .line 452
    invoke-virtual {v0, v6}, Landroid/support/v7/view/menu/MenuItemWrapperICS;->setExclusiveCheckable(Z)V
    ...
    .end local v16    # "$r10":Landroid/support/v7/view/menu/MenuItemImpl;, ""
    .end local v21    # "$r13":Landroid/view/View;, ""
    .end local v11    # "$r6":Landroid/content/Context;, ""
    .end local v19    # "$r11":[Ljava/lang/Class;, ""
    .end local v5    # "$i0":I, ""
    .end local v24    # "$r15":Landroid/support/v7/view/menu/MenuItemWrapperICS;, ""
    .end local v7    # "$r4":Ljava/lang/CharSequence;, ""
    .end local v10    # "$r5":Landroid/support/v7/view/SupportMenuInflater;, ""
    ...
    .end local v14    # "$r8":Landroid/support/v7/view/SupportMenuInflater$InflatedOnMenuItemClickListener;, ""
...
.method public addItem()V
    ...
    invoke-direct {p0, v6}, Landroid/support/v7/view/SupportMenuInflater$MenuState;->setItem(Landroid/view/MenuItem;)V
...
.method public addSubMenuItem()Landroid/view/SubMenu;
    ...
    invoke-direct {p0, v7}, Landroid/support/v7/view/SupportMenuInflater$MenuState;->setItem(Landroid/view/MenuItem;)V
...
.method public readGroup(Landroid/util/AttributeSet;)V
    ...
    .line 348
    .local v0, "$r3":Landroid/support/v7/view/SupportMenuInflater;, ""
    # getter for: Landroid/support/v7/view/SupportMenuInflater;->mContext:Landroid/content/Context;
    invoke-static {v0}, Landroid/support/v7/view/SupportMenuInflater;->access$100(Landroid/support/v7/view/SupportMenuInflater;)Landroid/content/Context;
    ...
    iput v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupId:I
    ...
    iput v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupCategory:I
    ...
    iput v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupOrder:I
    ...
    iput v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupCheckable:I
    ...
    .local v6, "$z0":Z, ""
    iput-boolean v6, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupVisible:Z
    ...
    iput-boolean v6, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupEnabled:Z
    ...
    .end local v0    # "$r3":Landroid/support/v7/view/SupportMenuInflater;, ""
    .end local v4    # "$i0":I, ""
.end method
...
.method public readItem(Landroid/util/AttributeSet;)V
    ...
    .line 366
    .local v2, "$r2":Landroid/support/v7/view/SupportMenuInflater;, ""
    iget-object v2, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->this$0:Landroid/support/v7/view/SupportMenuInflater;
    ...
    iput v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemId:I
    ...
    .local v8, "$i1":I, ""
    iget v8, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupCategory:I
    ...
    .local v9, "$i2":I, ""
    iget v9, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupOrder:I
    ...
    iput v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemCategoryOrder:I
    ...
    iput-object v10, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemTitle:Ljava/lang/CharSequence;
    ...
    iput-object v10, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemTitleCondensed:Ljava/lang/CharSequence;
    ...
    iput v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemIconResId:I
    ...
    .line 377
    invoke-direct {v0, v11}, Landroid/support/v7/view/SupportMenuInflater$MenuState;->getShortcut(Ljava/lang/String;)C
    ...
    iput-char v12, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemAlphabeticShortcut:C
    ...
    iput-char v12, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemNumericShortcut:C
    ...
    iput v14, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemCheckable:I
    ...
    iput-boolean v13, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemChecked:Z
    ...
    iget-boolean v13, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupVisible:Z
    ...
    iput-boolean v13, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemVisible:Z
    ...
    iget-boolean v13, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupEnabled:Z
    ...
    iput-boolean v13, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemEnabled:Z
    ...
    iput v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemShowAsAction:I
    ...
    iput-object v11, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemListenerMethodName:Ljava/lang/String;
    ...
    iput v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionViewLayout:I
    ...
    iput-object v11, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionViewClassName:Ljava/lang/String;
    ...
    iput-object v11, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionProviderClassName:Ljava/lang/String;

    .line 398
    move-object/from16 v0, p0

    .line 398
    iget-object v11, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionProviderClassName:Ljava/lang/String;
    ...
    iget v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionViewLayout:I

    if-nez v6, :cond_141

    move-object/from16 v0, p0

    iget-object v11, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionViewClassName:Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/support/v7/view/SupportMenuInflater;->access$300(Landroid/support/v7/view/SupportMenuInflater;)[Ljava/lang/Object;
    ...
    .line 400
    invoke-direct {v0, v11, v15, v1}, Landroid/support/v7/view/SupportMenuInflater$MenuState;->newInstance(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, v1, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemActionProvider:Landroid/support/v4/view/ActionProvider;
    ...
    .line 413
    iput-boolean v7, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemAdded:Z
    ...
    .line 387
    iget v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->groupCheckable:I

    move-object/from16 v0, p0

    iput v6, v0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemCheckable:I
    ...
    .end local v2    # "$r2":Landroid/support/v7/view/SupportMenuInflater;, ""
