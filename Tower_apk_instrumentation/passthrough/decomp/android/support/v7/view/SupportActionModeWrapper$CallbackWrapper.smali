...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V
    ...
    iput-object v1, p0, Landroid/support/v7/view/SupportActionModeWrapper$CallbackWrapper;->mMenus:Landroid/support/v4/util/SimpleArrayMap;
...
.method private getMenuWrapper(Landroid/view/Menu;)Landroid/view/Menu;
    ...
    .line 180
    iget-object v4, p0, Landroid/support/v7/view/SupportActionModeWrapper$CallbackWrapper;->mContext:Landroid/content/Context;
    ...
    invoke-static {v4, v5}, Landroid/support/v7/view/menu/MenuWrapperFactory;->wrapSupportMenu(Landroid/content/Context;Landroid/support/v4/internal/view/SupportMenu;)Landroid/view/Menu;
...
.method public getActionModeWrapper(Landroid/support/v7/view/ActionMode;)Landroid/view/ActionMode;
    ...
    .local v4, "$r4":Landroid/support/v7/view/SupportActionModeWrapper;, ""
    if-eqz v4, :cond_1a

    iget-object v6, v4, Landroid/support/v7/view/SupportActionModeWrapper;->mWrappedObject:Landroid/support/v7/view/ActionMode;
    ...
    .line 198
    :cond_1d
    new-instance v4, Landroid/support/v7/view/SupportActionModeWrapper;

    iget-object v7, p0, Landroid/support/v7/view/SupportActionModeWrapper$CallbackWrapper;->mContext:Landroid/content/Context;

    .line 198
    .local v7, "$r6":Landroid/content/Context;, ""
    invoke-direct {v4, v7, p1}, Landroid/support/v7/view/SupportActionModeWrapper;-><init>(Landroid/content/Context;Landroid/support/v7/view/ActionMode;)V
    ...
    .end local v4    # "$r4":Landroid/support/v7/view/SupportActionModeWrapper;, ""
.end method
