...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 64
    new-instance v2, Landroid/support/v7/widget/AppCompatImageHelper;

    .line 64
    .local v2, "$r5":Landroid/support/v7/widget/AppCompatImageHelper;, ""
    invoke-direct {v2, p0, v0}, Landroid/support/v7/widget/AppCompatImageHelper;-><init>(Landroid/widget/ImageView;Landroid/support/v7/widget/AppCompatDrawableManager;)V

    iput-object v2, p0, Landroid/support/v7/widget/AppCompatImageButton;->mImageHelper:Landroid/support/v7/widget/AppCompatImageHelper;

    .line 65
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatImageButton;->mImageHelper:Landroid/support/v7/widget/AppCompatImageHelper;

    .line 65
    invoke-virtual {v2, p2, p3}, Landroid/support/v7/widget/AppCompatImageHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V

    .line 66
    return-void
    .end local v1    # "$r4":Landroid/support/v7/widget/AppCompatBackgroundHelper;, ""
    .end local v2    # "$r5":Landroid/support/v7/widget/AppCompatImageHelper;, ""
