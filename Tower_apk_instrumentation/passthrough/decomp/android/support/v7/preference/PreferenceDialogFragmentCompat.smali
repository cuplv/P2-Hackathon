...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 73
    invoke-super {v0, v1}, Landroid/support/v4/app/DialogFragment;->onCreate(Landroid/os/Bundle;)V

    .line 75
    move-object/from16 v0, p0

    .line 75
    invoke-virtual {v0}, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->getTargetFragment()Landroid/support/v4/app/Fragment;
    ...
    .line 84
    invoke-virtual {v0}, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->getArguments()Landroid/os/Bundle;
    ...
    iput-object v14, v0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mPreference:Landroid/support/v7/preference/DialogPreference;

    .line 87
    move-object/from16 v0, p0

    .line 87
    iget-object v14, v0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mPreference:Landroid/support/v7/preference/DialogPreference;
    ...
    iput-object v0, v1, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogTitle:Ljava/lang/CharSequence;
    ...
    iput-object v0, v1, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mPositiveButtonText:Ljava/lang/CharSequence;
    ...
    iput-object v0, v1, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mNegativeButtonText:Ljava/lang/CharSequence;
    ...
    iput-object v0, v1, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogMessage:Ljava/lang/CharSequence;
    ...
    iput v0, v1, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogLayoutRes:I
    ...
    iput-object v0, v1, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogIcon:Landroid/graphics/drawable/BitmapDrawable;
    ...
    .line 102
    invoke-virtual {v0}, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->getResources()Landroid/content/res/Resources;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 137
    .local v2, "$r3":Landroid/support/v7/app/AlertDialog$Builder;, ""
    invoke-direct {v2, v0}, Landroid/support/v7/app/AlertDialog$Builder;-><init>(Landroid/content/Context;)V

    iget-object v3, p0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogTitle:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogIcon:Landroid/graphics/drawable/BitmapDrawable;

    .line 137
    .local v4, "$r5":Landroid/graphics/drawable/BitmapDrawable;, ""
    invoke-virtual {v2, v4}, Landroid/support/v7/app/AlertDialog$Builder;->setIcon(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/app/AlertDialog$Builder;

    move-result-object v2

    iget-object v3, p0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mPositiveButtonText:Ljava/lang/CharSequence;

    .line 137
    invoke-virtual {v2, v3, p0}, Landroid/support/v7/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;

    move-result-object v2

    iget-object v3, p0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mNegativeButtonText:Ljava/lang/CharSequence;

    .line 137
    invoke-virtual {v2, v3, p0}, Landroid/support/v7/app/AlertDialog$Builder;->setNegativeButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/AlertDialog$Builder;
    ...
    .line 145
    invoke-virtual {p0, v5}, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->onBindDialogView(Landroid/view/View;)V
    ...
    .line 151
    :goto_30
    invoke-virtual {p0, v2}, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->onPrepareDialogBuilder(Landroid/support/v7/app/AlertDialog$Builder;)V
    ...
    .line 155
    .local v6, "$r7":Landroid/support/v7/app/AlertDialog;, ""
    ...
    .line 156
    invoke-direct {p0, v6}, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->requestInputMethod(Landroid/app/Dialog;)V
    ...
    .end local v6    # "$r7":Landroid/support/v7/app/AlertDialog;, ""
    .end local v5    # "$r6":Landroid/view/View;, ""
    .end local v3    # "$r4":Ljava/lang/CharSequence;, ""
    .end local v2    # "$r3":Landroid/support/v7/app/AlertDialog$Builder;, ""
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    .local v2, "$z0":Z, ""
    :goto_9
    invoke-virtual {p0, v2}, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->onDialogClosed(Z)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget v2, p0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogLayoutRes:I
    ...
    .line 126
    iget-object v3, p0, Landroid/support/v7/preference/PreferenceDialogFragmentCompat;->mDialogIcon:Landroid/graphics/drawable/BitmapDrawable;
