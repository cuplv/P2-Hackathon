...
.method static constructor <clinit>()V
    ...
    .line 33
    .local v0, "$r0":Landroid/support/v4/text/TextDirectionHeuristicsCompat$TextDirectionHeuristicInternal;, ""
    const/4 v1, 0x0
    ...
    .line 47
    .local v4, "$r1":Landroid/support/v4/text/TextDirectionHeuristicsCompat$FirstStrong;, ""
    const/4 v2, 0x0
    ...
    .line 62
    .local v5, "$r2":Landroid/support/v4/text/TextDirectionHeuristicsCompat$AnyStrong;, ""
    const/4 v2, 0x0
    ...
    .local v6, "$r3":Landroid/support/v4/text/TextDirectionHeuristicsCompat$TextDirectionHeuristicLocale;, ""
    ...
    return-void
    .end local v4    # "$r1":Landroid/support/v4/text/TextDirectionHeuristicsCompat$FirstStrong;, ""
    .end local v0    # "$r0":Landroid/support/v4/text/TextDirectionHeuristicsCompat$TextDirectionHeuristicInternal;, ""
    .end local v5    # "$r2":Landroid/support/v4/text/TextDirectionHeuristicsCompat$AnyStrong;, ""
    .end local v6    # "$r3":Landroid/support/v4/text/TextDirectionHeuristicsCompat$TextDirectionHeuristicLocale;, ""
.end method
