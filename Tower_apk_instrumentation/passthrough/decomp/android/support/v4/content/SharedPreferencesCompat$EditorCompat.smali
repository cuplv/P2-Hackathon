...
.method private constructor <init>()V
    ...
    .line 53
    .local v2, "$r1":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$EditorHelperApi9Impl;, ""
    const/4 v3, 0x0

    .line 53
    invoke-direct {v2, v3}, Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$EditorHelperApi9Impl;-><init>(Landroid/support/v4/content/SharedPreferencesCompat$1;)V

    iput-object v2, p0, Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat;->mHelper:Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$Helper;
    ...
    .line 55
    :cond_12
    new-instance v4, Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$EditorHelperBaseImpl;

    .line 55
    .local v4, "$r2":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$EditorHelperBaseImpl;, ""
    const/4 v3, 0x0

    .line 55
    invoke-direct {v4, v3}, Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$EditorHelperBaseImpl;-><init>(Landroid/support/v4/content/SharedPreferencesCompat$1;)V

    iput-object v4, p0, Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat;->mHelper:Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$Helper;

    return-void
    .end local v0    # "$i0":I, ""
    .end local v2    # "$r1":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$EditorHelperApi9Impl;, ""
    .end local v4    # "$r2":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$EditorHelperBaseImpl;, ""
.end method
...
.method public static getInstance()Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat;
    ...
    .local v0, "$r0":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat;, ""
    if-nez v0, :cond_b
    ...
    return-object v0
    .end local v0    # "$r0":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat;, ""
.end method
...
.method public apply(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 67
    .local v0, "$r2":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$Helper;, ""
    ...
    .line 68
    return-void
    .end local v0    # "$r2":Landroid/support/v4/content/SharedPreferencesCompat$EditorCompat$Helper;, ""
.end method
