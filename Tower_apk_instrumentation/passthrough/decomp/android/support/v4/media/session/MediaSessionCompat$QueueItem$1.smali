...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;
    ...
    .line 943
    .local v0, "$r2":Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;, ""
    const/4 v1, 0x0
    ...
    return-object v0
    .end local v0    # "$r2":Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;, ""
.end method
...
.method public newArray(I)[Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;
    ...
    .local v0, "$r1":[Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;, ""
    return-object v0
    .end local v0    # "$r1":[Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;, ""
.end method
