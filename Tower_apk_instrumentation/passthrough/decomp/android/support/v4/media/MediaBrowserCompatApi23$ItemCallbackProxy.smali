...
.method public onError(Ljava/lang/String;)V
    ...
    .line 54
    .local v0, "$r2":Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallback;, ""
    invoke-interface {v0, p1}, Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallback;->onError(Ljava/lang/String;)V

    .line 55
    return-void
    .end local v0    # "$r2":Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallback;, ""
.end method
...
.method public onItemLoaded(Landroid/media/browse/MediaBrowser$MediaItem;)V
    ...
    .line 49
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallbackProxy;->mItemCallback:Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallback;

    .line 49
    .local v2, "$r3":Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallback;, ""
    invoke-interface {v2, v0}, Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallback;->onItemLoaded(Landroid/os/Parcel;)V

    .line 50
    return-void
    .end local v0    # "$r2":Landroid/os/Parcel;, ""
    .end local v2    # "$r3":Landroid/support/v4/media/MediaBrowserCompatApi23$ItemCallback;, ""
.end method
