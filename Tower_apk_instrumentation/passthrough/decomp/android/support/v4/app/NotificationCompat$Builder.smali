...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->mActions:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v4/app/NotificationCompat$Builder;->mNotification:Landroid/app/Notification;
    ...
    iput-object v1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->mPeople:Ljava/util/ArrayList;
...
.method public addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 1459
    .local v1, "$r4":Landroid/support/v4/app/NotificationCompat$Action;, ""
    ...
    .end local v1    # "$r4":Landroid/support/v4/app/NotificationCompat$Action;, ""
.end method
...
.method public build()Landroid/app/Notification;
    ...
    .line 1559
    .local v1, "$r2":Landroid/support/v4/app/NotificationCompat$BuilderExtender;, ""
    ...
    .end local v2    # "$r3":Landroid/app/Notification;, ""
    .end local v1    # "$r2":Landroid/support/v4/app/NotificationCompat$BuilderExtender;, ""
.end method
...
.method protected getExtender()Landroid/support/v4/app/NotificationCompat$BuilderExtender;
    ...
    .line 1566
    .local v0, "$r1":Landroid/support/v4/app/NotificationCompat$BuilderExtender;, ""
    invoke-direct {v0}, Landroid/support/v4/app/NotificationCompat$BuilderExtender;-><init>()V

    return-object v0
    .end local v0    # "$r1":Landroid/support/v4/app/NotificationCompat$BuilderExtender;, ""
.end method
...
.method public setLights(III)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iget p1, v1, Landroid/app/Notification;->ledOnMS:I
    ...
    iget p1, v1, Landroid/app/Notification;->ledOffMS:I
    ...
    .local v3, "$r2":Landroid/app/Notification;, ""
    ...
    .end local v0    # "$b3":B, ""
    .end local p1    # "$i0":I, ""
    .end local v3    # "$r2":Landroid/app/Notification;, ""
.end method
...
.method public setStyle(Landroid/support/v4/app/NotificationCompat$Style;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .local v0, "$r2":Landroid/support/v4/app/NotificationCompat$Style;, ""
    if-eq v0, p1, :cond_f
    ...
    .local p1, "$r1":Landroid/support/v4/app/NotificationCompat$Style;, ""
    if-eqz p1, :cond_f
    ...
    :cond_f
    return-object p0
    .end local p1    # "$r1":Landroid/support/v4/app/NotificationCompat$Style;, ""
    .end local v0    # "$r2":Landroid/support/v4/app/NotificationCompat$Style;, ""
.end method
