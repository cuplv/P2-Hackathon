...
.method static zza(Lcom/google/android/gms/common/data/DataHolder;Landroid/os/Parcel;I)V
    ...
    .local v5, "$r3":[Landroid/database/CursorWindow;, ""
    const/4 v2, 0x2

    const/4 v3, 0x0

    invoke-static {p1, v2, v5, p2, v3}, Lcom/google/android/gms/common/internal/safeparcel/zzb;->zza(Landroid/os/Parcel;I[Landroid/os/Parcelable;IZ)V
    ...
    .end local v0    # "$i1":I, ""
    .end local p2    # "$i0":I, ""
    .end local v5    # "$r3":[Landroid/database/CursorWindow;, ""
    .end local v4    # "$i2":I, ""
...
.method public zzS(Landroid/os/Parcel;)Lcom/google/android/gms/common/data/DataHolder;
    ...
    :cond_1
    new-instance v21, Lcom/google/android/gms/common/data/DataHolder;

    .local v21, "$r10":Lcom/google/android/gms/common/data/DataHolder;, ""
    ...
    .end local v21    # "$r10":Lcom/google/android/gms/common/data/DataHolder;, ""
    .end local v8    # "$i1":I, ""
