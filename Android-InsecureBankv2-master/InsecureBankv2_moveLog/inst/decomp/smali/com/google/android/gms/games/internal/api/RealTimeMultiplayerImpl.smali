...
.method public create(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/games/multiplayer/realtime/RoomConfig;)V
    ...
    .local v2, "$r4":Lcom/google/android/gms/games/multiplayer/realtime/RoomUpdateListener;, ""
    invoke-interface {p1, v2}, Lcom/google/android/gms/common/api/GoogleApiClient;->zzo(Ljava/lang/Object;)Lcom/google/android/gms/common/api/zzi;

    move-result-object v3

    .local v3, "$r5":Lcom/google/android/gms/common/api/zzi;, ""
    ...
    .local v4, "$r6":Lcom/google/android/gms/games/multiplayer/realtime/RoomStatusUpdateListener;, ""
    invoke-static {p1, v4}, Lcom/google/android/gms/games/internal/api/RealTimeMultiplayerImpl;->zza(Lcom/google/android/gms/common/api/GoogleApiClient;Ljava/lang/Object;)Lcom/google/android/gms/common/api/zzi;

    move-result-object v5

    .local v5, "$r7":Lcom/google/android/gms/common/api/zzi;, ""
    ...
    .local v6, "$r8":Lcom/google/android/gms/games/multiplayer/realtime/RealTimeMessageReceivedListener;, ""
    invoke-static {p1, v6}, Lcom/google/android/gms/games/internal/api/RealTimeMultiplayerImpl;->zza(Lcom/google/android/gms/common/api/GoogleApiClient;Ljava/lang/Object;)Lcom/google/android/gms/common/api/zzi;

    move-result-object v7

    .local v7, "$r9":Lcom/google/android/gms/common/api/zzi;, ""
    invoke-virtual {v0, v3, v5, v7, p2}, Lcom/google/android/gms/games/internal/GamesClientImpl;->zza(Lcom/google/android/gms/common/api/zzi;Lcom/google/android/gms/common/api/zzi;Lcom/google/android/gms/common/api/zzi;Lcom/google/android/gms/games/multiplayer/realtime/RoomConfig;)V

    return-void
    .end local v7    # "$r9":Lcom/google/android/gms/common/api/zzi;, ""
    .end local v2    # "$r4":Lcom/google/android/gms/games/multiplayer/realtime/RoomUpdateListener;, ""
    .end local v4    # "$r6":Lcom/google/android/gms/games/multiplayer/realtime/RoomStatusUpdateListener;, ""
    .end local v6    # "$r8":Lcom/google/android/gms/games/multiplayer/realtime/RealTimeMessageReceivedListener;, ""
    .end local v0    # "$r3":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
    .end local v3    # "$r5":Lcom/google/android/gms/common/api/zzi;, ""
    .end local v5    # "$r7":Lcom/google/android/gms/common/api/zzi;, ""
.end method
...
.method public getSelectOpponentsIntent(Lcom/google/android/gms/common/api/GoogleApiClient;II)Landroid/content/Intent;
    ...
    invoke-virtual {v0, p2, p3, v2}, Lcom/google/android/gms/games/internal/GamesClientImpl;->zzc(IIZ)Landroid/content/Intent;
...
.method public join(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/games/multiplayer/realtime/RoomConfig;)V
    ...
    .local v7, "$r9":Lcom/google/android/gms/common/api/zzi;, ""
    invoke-virtual {v0, v3, v5, v7, p2}, Lcom/google/android/gms/games/internal/GamesClientImpl;->zzb(Lcom/google/android/gms/common/api/zzi;Lcom/google/android/gms/common/api/zzi;Lcom/google/android/gms/common/api/zzi;Lcom/google/android/gms/games/multiplayer/realtime/RoomConfig;)V
...
.method public leave(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/games/multiplayer/realtime/RoomUpdateListener;Ljava/lang/String;)V
    ...
    .local v2, "$r5":Lcom/google/android/gms/common/api/zzi;, ""
    invoke-virtual {v0, v2, p3}, Lcom/google/android/gms/games/internal/GamesClientImpl;->zza(Lcom/google/android/gms/common/api/zzi;Ljava/lang/String;)V

    :cond_0
    return-void
    .end local v0    # "$r4":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
    .end local v2    # "$r5":Lcom/google/android/gms/common/api/zzi;, ""
.end method
...
.method public sendReliableMessage(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/games/multiplayer/realtime/RealTimeMultiplayer$ReliableMessageSentCallback;[BLjava/lang/String;Ljava/lang/String;)I
    ...
    .local v1, "$r7":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
    ...
    .local v2, "$i0":I, ""
    return v2
    .end local v1    # "$r7":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
    .end local v2    # "$i0":I, ""
...
.method public sendUnreliableMessage(Lcom/google/android/gms/common/api/GoogleApiClient;[BLjava/lang/String;Ljava/lang/String;)I
    ...
    .local v0, "$r5":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
    const/4 v2, 0x1
    ...
    .end local v0    # "$r5":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
    .end local v3    # "$i0":I, ""
.end method
...
.method public sendUnreliableMessage(Lcom/google/android/gms/common/api/GoogleApiClient;[BLjava/lang/String;Ljava/util/List;)I
    ...
    .local v4, "$r7":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
    invoke-virtual {v4, p2, p3, v1}, Lcom/google/android/gms/games/internal/GamesClientImpl;->zza([BLjava/lang/String;[Ljava/lang/String;)I
    ...
    .end local v4    # "$r7":Lcom/google/android/gms/games/internal/GamesClientImpl;, ""
