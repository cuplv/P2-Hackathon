...
.method public constructor <init>(Lcom/google/android/gms/common/api/zza$zzb;Lcom/google/android/gms/wearable/internal/zzq;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/wearable/internal/zzbj$zzi;->zzaUQ:Lcom/google/android/gms/wearable/internal/zzq;
...
.method public zza(Lcom/google/android/gms/wearable/internal/GetChannelOutputStreamResponse;)V
    ...
    .local v0, "$r3":Lcom/google/android/gms/wearable/internal/zzn;, ""
    ...
    .local v2, "$r5":Landroid/os/ParcelFileDescriptor$AutoCloseOutputStream;, ""
    iget-object v1, p1, Lcom/google/android/gms/wearable/internal/GetChannelOutputStreamResponse;->zzaUs:Landroid/os/ParcelFileDescriptor;

    invoke-direct {v2, v1}, Landroid/os/ParcelFileDescriptor$AutoCloseOutputStream;-><init>(Landroid/os/ParcelFileDescriptor;)V

    invoke-direct {v0, v2}, Lcom/google/android/gms/wearable/internal/zzn;-><init>(Ljava/io/OutputStream;)V

    iget-object v3, p0, Lcom/google/android/gms/wearable/internal/zzbj$zzi;->zzaUQ:Lcom/google/android/gms/wearable/internal/zzq;
    ...
    :cond_0
    new-instance v5, Lcom/google/android/gms/wearable/internal/ChannelImpl$zzb;

    .local v5, "$r7":Lcom/google/android/gms/wearable/internal/ChannelImpl$zzb;, ""
    new-instance v6, Lcom/google/android/gms/common/api/Status;

    .local v6, "$r8":Lcom/google/android/gms/common/api/Status;, ""
    iget v7, p1, Lcom/google/android/gms/wearable/internal/GetChannelOutputStreamResponse;->statusCode:I

    .local v7, "$i0":I, ""
    invoke-direct {v6, v7}, Lcom/google/android/gms/common/api/Status;-><init>(I)V

    invoke-direct {v5, v6, v0}, Lcom/google/android/gms/wearable/internal/ChannelImpl$zzb;-><init>(Lcom/google/android/gms/common/api/Status;Ljava/io/OutputStream;)V

    invoke-virtual {p0, v5}, Lcom/google/android/gms/wearable/internal/zzbj$zzi;->zzP(Ljava/lang/Object;)V

    return-void
    .end local v0    # "$r3":Lcom/google/android/gms/wearable/internal/zzn;, ""
    ...
    .end local v5    # "$r7":Lcom/google/android/gms/wearable/internal/ChannelImpl$zzb;, ""
    .end local v2    # "$r5":Landroid/os/ParcelFileDescriptor$AutoCloseOutputStream;, ""
