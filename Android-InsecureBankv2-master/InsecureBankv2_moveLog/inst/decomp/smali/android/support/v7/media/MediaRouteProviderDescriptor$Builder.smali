...
.method public constructor <init>(Landroid/support/v7/media/MediaRouteProviderDescriptor;)V
    ...
    iput-object v2, p0, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->mBundle:Landroid/os/Bundle;
    ...
    iput-object v6, p0, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->mRoutes:Ljava/util/ArrayList;
...
.method public addRoute(Landroid/support/v7/media/MediaRouteDescriptor;)Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;
    ...
    iput-object v2, p0, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->mRoutes:Ljava/util/ArrayList;
...
.method public addRoutes(Ljava/util/Collection;)Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;
    ...
    invoke-virtual {p0, v5}, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->addRoute(Landroid/support/v7/media/MediaRouteDescriptor;)Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;
...
.method public build()Landroid/support/v7/media/MediaRouteProviderDescriptor;
    ...
    .line 190
    .local v5, "$r4":Landroid/support/v7/media/MediaRouteDescriptor;, ""
    invoke-virtual {v5}, Landroid/support/v7/media/MediaRouteDescriptor;->asBundle()Landroid/os/Bundle;
    ...
    .line 192
    :cond_0
    iget-object v7, p0, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->mBundle:Landroid/os/Bundle;
    ...
    .line 194
    :cond_1
    new-instance v9, Landroid/support/v7/media/MediaRouteProviderDescriptor;

    .local v9, "$r6":Landroid/support/v7/media/MediaRouteProviderDescriptor;, ""
    iget-object v7, p0, Landroid/support/v7/media/MediaRouteProviderDescriptor$Builder;->mBundle:Landroid/os/Bundle;
    ...
    .line 194
    invoke-direct {v9, v7, v0, v10}, Landroid/support/v7/media/MediaRouteProviderDescriptor;-><init>(Landroid/os/Bundle;Ljava/util/List;Landroid/support/v7/media/MediaRouteProviderDescriptor$1;)V
    ...
    .end local v9    # "$r6":Landroid/support/v7/media/MediaRouteProviderDescriptor;, ""
    .end local v5    # "$r4":Landroid/support/v7/media/MediaRouteDescriptor;, ""
    .end local v1    # "$i0":I, ""
.end method
