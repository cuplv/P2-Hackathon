...
.method public static obtain(Landroid/content/Context;Ljava/lang/Object;)Landroid/support/v7/media/RemoteControlClientCompat;
    ...
    .line 42
    new-instance v2, Landroid/support/v7/media/RemoteControlClientCompat$JellybeanImpl;

    .line 42
    .local v2, "$r2":Landroid/support/v7/media/RemoteControlClientCompat$JellybeanImpl;, ""
    invoke-direct {v2, p0, p1}, Landroid/support/v7/media/RemoteControlClientCompat$JellybeanImpl;-><init>(Landroid/content/Context;Ljava/lang/Object;)V

    .line 44
    return-object v2

    :cond_0
    new-instance v3, Landroid/support/v7/media/RemoteControlClientCompat$LegacyImpl;

    .line 44
    .local v3, "$r3":Landroid/support/v7/media/RemoteControlClientCompat$LegacyImpl;, ""
    invoke-direct {v3, p0, p1}, Landroid/support/v7/media/RemoteControlClientCompat$LegacyImpl;-><init>(Landroid/content/Context;Ljava/lang/Object;)V

    return-object v3
    .end local v3    # "$r3":Landroid/support/v7/media/RemoteControlClientCompat$LegacyImpl;, ""
    .end local v2    # "$r2":Landroid/support/v7/media/RemoteControlClientCompat$JellybeanImpl;, ""
    .end local v0    # "$i0":I, ""
.end method
