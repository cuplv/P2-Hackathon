...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v3, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mBackground:Landroid/graphics/drawable/Drawable;
    ...
    .local v4, "$z0":Z, ""
    iput-boolean v4, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mPreserveIconSpacing:Z
...
.method private getInflater()Landroid/view/LayoutInflater;
    ...
    .line 277
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mContext:Landroid/content/Context;
...
.method private insertCheckBox()V
    ...
    iput-object v4, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mCheckBox:Landroid/widget/CheckBox;

    .line 264
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mCheckBox:Landroid/widget/CheckBox;

    .line 264
    invoke-virtual {p0, v4}, Landroid/support/v7/internal/view/menu/ListMenuItemView;->addView(Landroid/view/View;)V
...
.method private insertIconView()V
    ...
    iput-object v4, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mIconView:Landroid/widget/ImageView;

    .line 248
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mIconView:Landroid/widget/ImageView;

    .line 248
    const/4 v3, 0x0

    .line 248
    invoke-virtual {p0, v4, v3}, Landroid/support/v7/internal/view/menu/ListMenuItemView;->addView(Landroid/view/View;I)V
...
.method private insertRadioButton()V
    ...
    iput-object v4, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mRadioButton:Landroid/widget/RadioButton;
...
.method public initialize(Landroid/support/v7/internal/view/menu/MenuItemImpl;I)V
    ...
    .local v1, "$b1":B, ""
    :goto_0
    invoke-virtual {p0, v1}, Landroid/support/v7/internal/view/menu/ListMenuItemView;->setVisibility(I)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/internal/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 106
    .local v3, "$c2":C, ""
    invoke-virtual {p0, v0, v3}, Landroid/support/v7/internal/view/menu/ListMenuItemView;->setShortcut(ZC)V
    ...
    invoke-virtual {p0, v4}, Landroid/support/v7/internal/view/menu/ListMenuItemView;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method protected onFinishInflate()V
    ...
    .line 89
    .local v1, "$i0":I, ""
    invoke-virtual {p0, v1}, Landroid/support/v7/internal/view/menu/ListMenuItemView;->findViewById(I)Landroid/view/View;
    ...
    iput-object v3, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mTitleView:Landroid/widget/TextView;
    ...
    .line 91
    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mTitleView:Landroid/widget/TextView;

    iget-object v6, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mTextAppearanceContext:Landroid/content/Context;
    ...
    iput-object v3, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mShortcutView:Landroid/widget/TextView;
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mPreserveIconSpacing:Z
...
.method public setCheckable(Z)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/internal/view/menu/MenuItemImpl;->isExclusiveCheckable()Z
    ...
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mCheckBox:Landroid/widget/CheckBox;
    ...
    .line 154
    invoke-virtual {v2}, Landroid/support/v7/internal/view/menu/MenuItemImpl;->isChecked()Z
    ...
    .line 150
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mRadioButton:Landroid/widget/RadioButton;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-boolean v1, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mForceShowIcon:Z
    ...
    .line 212
    :cond_2
    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mIconView:Landroid/widget/ImageView;
...
.method public setShortcut(ZC)V
    ...
    .line 198
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/ListMenuItemView;->mShortcutView:Landroid/widget/TextView;
