...
.method protected addItemView(Landroid/view/View;I)V
    ...
    .local v3, "$r4":Landroid/support/v7/internal/view/menu/MenuView;, ""
    move-object v4, v3
    ...
    .line 134
    return-void
    .end local v3    # "$r4":Landroid/support/v7/internal/view/menu/MenuView;, ""
...
.method public createItemView(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/MenuView$ItemView;
    ...
    .local v4, "$r4":Landroid/support/v7/internal/view/menu/MenuView$ItemView;, ""
    return-object v4
    .end local v4    # "$r4":Landroid/support/v7/internal/view/menu/MenuView$ItemView;, ""
...
.method public getCallback()Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;
    ...
    .local v0, "r1":Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;, ""
    return-object v0
    .end local v0    # "r1":Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;, ""
.end method
...
.method public getItemView(Landroid/support/v7/internal/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 182
    .local v1, "$r4":Landroid/support/v7/internal/view/menu/MenuView$ItemView;, ""
    :goto_0
    ...
    goto :goto_0
    .end local v1    # "$r4":Landroid/support/v7/internal/view/menu/MenuView$ItemView;, ""
...
.method public getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/MenuView;
    ...
    .local v0, "$r3":Landroid/support/v7/internal/view/menu/MenuView;, ""
    if-nez v0, :cond_0
    ...
    .line 75
    .local v6, "$r5":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
    ...
    return-object v0
    .end local v0    # "$r3":Landroid/support/v7/internal/view/menu/MenuView;, ""
    .end local v1    # "$r4":Landroid/view/LayoutInflater;, ""
    .end local v6    # "$r5":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
    .end local v2    # "$i0":I, ""
...
.method public updateMenuView(Z)V
    ...
    .line 86
    .local v2, "$r1":Landroid/support/v7/internal/view/menu/MenuView;, ""
    ...
    .line 90
    .local v6, "$r3":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
    ...
    .line 96
    .local v11, "$r6":Landroid/support/v7/internal/view/menu/MenuItemImpl;, ""
    move-object/from16 v0, p0
    ...
    .line 98
    .local v14, "$r8":Landroid/support/v7/internal/view/menu/MenuView$ItemView;, ""
    ...
    .line 100
    .local v16, "$r9":Landroid/support/v7/internal/view/menu/MenuItemImpl;, ""
    :goto_1
    move-object/from16 v0, p0
    ...
    .end local v14    # "$r8":Landroid/support/v7/internal/view/menu/MenuView$ItemView;, ""
    .end local v3    # "$r2":Landroid/view/ViewGroup;, ""
    .end local v6    # "$r3":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
    .end local p1    # "$z0":Z, ""
    .end local v10    # "$r5":Ljava/lang/Object;, ""
    .end local v11    # "$r6":Landroid/support/v7/internal/view/menu/MenuItemImpl;, ""
    .end local v7    # "$r4":Ljava/util/ArrayList;, ""
    .end local v9    # "$i2":I, ""
    .end local v13    # "$r7":Landroid/view/View;, ""
    .end local v8    # "$i1":I, ""
    .end local v16    # "$r9":Landroid/support/v7/internal/view/menu/MenuItemImpl;, ""
    .end local v2    # "$r1":Landroid/support/v7/internal/view/menu/MenuView;, ""
    .end local v5    # "$i0":I, ""
.end method
