...
.method public collapseActionView()Z
    ...
    .line 705
    .local v5, "$r3":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
    ...
    .end local v5    # "$r3":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
.end method
...
.method public expandActionView()Z
    ...
    .line 685
    :cond_0
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/MenuItemImpl;->mOnActionExpandListener:Landroid/support/v4/view/MenuItemCompat$OnActionExpandListener;
    ...
    .line 687
    .local v3, "$r2":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
    invoke-virtual {v3, p0}, Landroid/support/v7/internal/view/menu/MenuBuilder;->expandItemActionView(Landroid/support/v7/internal/view/menu/MenuItemImpl;)Z
    ...
    .end local v3    # "$r2":Landroid/support/v7/internal/view/menu/MenuBuilder;, ""
.end method
...
.method public getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 422
    invoke-static {v3, v1}, Landroid/support/v7/internal/widget/TintManager;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    const/4 v4, 0x0

    iput v4, p0, Landroid/support/v7/internal/view/menu/MenuItemImpl;->mIconResId:I
...
.method getShortcut()C
    ...
    iget-char v2, p0, Landroid/support/v7/internal/view/menu/MenuItemImpl;->mShortcutAlphabeticChar:C

    .local v2, "c0":C, ""
    return v2

    :cond_0
    iget-char v2, p0, Landroid/support/v7/internal/view/menu/MenuItemImpl;->mShortcutNumericChar:C
...
.method public getSubMenu()Landroid/view/SubMenu;
    ...
    .local v0, "r1":Landroid/support/v7/internal/view/menu/SubMenuBuilder;, ""
    return-object v0
    .end local v0    # "r1":Landroid/support/v7/internal/view/menu/SubMenuBuilder;, ""
.end method
...
.method public setSupportActionProvider(Landroid/support/v4/view/ActionProvider;)Landroid/support/v4/internal/view/SupportMenuItem;
    ...
    .line 663
    .local v4, "$r4":Landroid/support/v7/internal/view/menu/MenuItemImpl$1;, ""
    ...
    .end local v4    # "$r4":Landroid/support/v7/internal/view/menu/MenuItemImpl$1;, ""
