...
.method static constructor <clinit>()V
    ...
    .line 154
    new-instance v2, Landroid/support/v4/view/MotionEventCompat$HoneycombMr1MotionEventVersionImpl;

    .line 154
    .local v2, "$r0":Landroid/support/v4/view/MotionEventCompat$HoneycombMr1MotionEventVersionImpl;, ""
    invoke-direct {v2}, Landroid/support/v4/view/MotionEventCompat$HoneycombMr1MotionEventVersionImpl;-><init>()V

    sput-object v2, Landroid/support/v4/view/MotionEventCompat;->IMPL:Landroid/support/v4/view/MotionEventCompat$MotionEventVersionImpl;
    ...
    .line 156
    new-instance v3, Landroid/support/v4/view/MotionEventCompat$GingerbreadMotionEventVersionImpl;

    .line 156
    .local v3, "$r1":Landroid/support/v4/view/MotionEventCompat$GingerbreadMotionEventVersionImpl;, ""
    invoke-direct {v3}, Landroid/support/v4/view/MotionEventCompat$GingerbreadMotionEventVersionImpl;-><init>()V

    sput-object v3, Landroid/support/v4/view/MotionEventCompat;->IMPL:Landroid/support/v4/view/MotionEventCompat$MotionEventVersionImpl;
    ...
    .line 158
    new-instance v4, Landroid/support/v4/view/MotionEventCompat$EclairMotionEventVersionImpl;

    .line 158
    .local v4, "$r2":Landroid/support/v4/view/MotionEventCompat$EclairMotionEventVersionImpl;, ""
    invoke-direct {v4}, Landroid/support/v4/view/MotionEventCompat$EclairMotionEventVersionImpl;-><init>()V

    sput-object v4, Landroid/support/v4/view/MotionEventCompat;->IMPL:Landroid/support/v4/view/MotionEventCompat$MotionEventVersionImpl;

    return-void

    .line 160
    :cond_2
    new-instance v5, Landroid/support/v4/view/MotionEventCompat$BaseMotionEventVersionImpl;

    .line 160
    .local v5, "$r3":Landroid/support/v4/view/MotionEventCompat$BaseMotionEventVersionImpl;, ""
    invoke-direct {v5}, Landroid/support/v4/view/MotionEventCompat$BaseMotionEventVersionImpl;-><init>()V

    sput-object v5, Landroid/support/v4/view/MotionEventCompat;->IMPL:Landroid/support/v4/view/MotionEventCompat$MotionEventVersionImpl;

    return-void
    .end local v4    # "$r2":Landroid/support/v4/view/MotionEventCompat$EclairMotionEventVersionImpl;, ""
    .end local v0    # "$i0":I, ""
    .end local v2    # "$r0":Landroid/support/v4/view/MotionEventCompat$HoneycombMr1MotionEventVersionImpl;, ""
    .end local v3    # "$r1":Landroid/support/v4/view/MotionEventCompat$GingerbreadMotionEventVersionImpl;, ""
    .end local v5    # "$r3":Landroid/support/v4/view/MotionEventCompat$BaseMotionEventVersionImpl;, ""
.end method
...
.method public static findPointerIndex(Landroid/view/MotionEvent;I)I
    ...
    .line 444
    .local v0, "$r1":Landroid/support/v4/view/MotionEventCompat$MotionEventVersionImpl;, ""
    ...
    .local p1, "$i0":I, ""
    return p1
    .end local v0    # "$r1":Landroid/support/v4/view/MotionEventCompat$MotionEventVersionImpl;, ""
    .end local p1    # "$i0":I, ""
.end method
