...
.method private constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v3, p0, Landroid/support/v4/media/MediaDescriptionCompat;->mTitle:Ljava/lang/CharSequence;
    ...
    iput-object v3, p0, Landroid/support/v4/media/MediaDescriptionCompat;->mSubtitle:Ljava/lang/CharSequence;
    ...
    iput-object v3, p0, Landroid/support/v4/media/MediaDescriptionCompat;->mDescription:Ljava/lang/CharSequence;
    ...
    iput-object v9, p0, Landroid/support/v4/media/MediaDescriptionCompat;->mIcon:Landroid/graphics/Bitmap;
    ...
    iput-object v11, p0, Landroid/support/v4/media/MediaDescriptionCompat;->mIconUri:Landroid/net/Uri;
    ...
    iput-object v13, p0, Landroid/support/v4/media/MediaDescriptionCompat;->mExtras:Landroid/os/Bundle;
...
.method public static fromMediaDescription(Ljava/lang/Object;)Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    invoke-virtual {v3, v8}, Landroid/support/v4/media/MediaDescriptionCompat$Builder;->setExtras(Landroid/os/Bundle;)Landroid/support/v4/media/MediaDescriptionCompat$Builder;
    ...
    .line 228
    .local v9, "$r7":Landroid/support/v4/media/MediaDescriptionCompat;, ""
    iput-object p0, v9, Landroid/support/v4/media/MediaDescriptionCompat;->mDescriptionObj:Ljava/lang/Object;

    return-object v9
    .end local v0    # "$i0":I, ""
    .end local v5    # "$r3":Ljava/lang/CharSequence;, ""
    .end local v9    # "$r7":Landroid/support/v4/media/MediaDescriptionCompat;, ""
