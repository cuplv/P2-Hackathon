...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;
    ...
    .line 877
    .local v0, "$r2":Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;, ""
    invoke-direct {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;-><init>(Landroid/os/Parcel;)V

    return-object v0
    .end local v0    # "$r2":Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;, ""
.end method
...
.method public newArray(I)[Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;
    ...
    .local v0, "$r1":[Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;, ""
    return-object v0
    .end local v0    # "$r1":[Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;, ""
.end method
