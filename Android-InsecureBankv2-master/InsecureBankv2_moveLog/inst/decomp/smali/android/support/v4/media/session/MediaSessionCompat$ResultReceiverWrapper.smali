...
.method static constructor <clinit>()V
    ...
    .line 874
    .local v0, "$r0":Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper$1;, ""
    ...
    return-void
    .end local v0    # "$r0":Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper$1;, ""
.end method
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    .local v2, "$r4":Landroid/os/ResultReceiver;, ""
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;->mResultReceiver:Landroid/os/ResultReceiver;

    .line 871
    return-void
    .end local v1    # "$r2":Ljava/lang/Object;, ""
    .end local v2    # "$r4":Landroid/os/ResultReceiver;, ""
...
.method static synthetic access$600(Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)Landroid/os/ResultReceiver;
    ...
    .local v0, "r1":Landroid/os/ResultReceiver;, ""
    return-object v0
    .end local v0    # "r1":Landroid/os/ResultReceiver;, ""
.end method
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 893
    .local v0, "$r2":Landroid/os/ResultReceiver;, ""
    invoke-virtual {v0, p1, p2}, Landroid/os/ResultReceiver;->writeToParcel(Landroid/os/Parcel;I)V

    .line 894
    return-void
    .end local v0    # "$r2":Landroid/os/ResultReceiver;, ""
.end method
