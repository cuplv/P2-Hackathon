...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    .line 69
    .local v0, "$r2":Landroid/support/v4/media/session/ParcelableVolumeInfo;, ""
    invoke-direct {v0, p1}, Landroid/support/v4/media/session/ParcelableVolumeInfo;-><init>(Landroid/os/Parcel;)V

    return-object v0
    .end local v0    # "$r2":Landroid/support/v4/media/session/ParcelableVolumeInfo;, ""
.end method
...
.method public newArray(I)[Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    .local v0, "$r1":[Landroid/support/v4/media/session/ParcelableVolumeInfo;, ""
    return-object v0
    .end local v0    # "$r1":[Landroid/support/v4/media/session/ParcelableVolumeInfo;, ""
.end method
